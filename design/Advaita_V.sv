...
module Advaita_V (
    ...
    // --- Internal Wires ---
    wire [31:0] instruction /* verilator public_flat_rd */;
    wire [31:0] pc_address;
    wire [31:0] alu_result;
    wire [31:0] rs2_data /* verilator public_flat_rd */;
    wire [31:0] cpu_mem_out /* verilator public_flat_rd */;         // Combined read data from wrapper
    wire        mem_write_en;
    wire        mem_read_en /* verilator public_flat_rd */;        
    wire [2:0]  instr_fn3;
    ...
    wire [31:0] mepc_val;
    wire        csr_write_en /* verilator public_flat_rd */;
  //  wire [2:0]  csr_op_type;
    wire [11:0] csr_address /* verilator public_flat_rd */;
